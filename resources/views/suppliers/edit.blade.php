...
@section('title')
	Edit Customer - <?php echo ucwords(strtolower(! empty($supplier->supplier_name) ? $supplier->supplier_name : '')); ?>
@endsection
...
@endif
	...
	<div class="row">
		...
		<div class="col-sm-10">
			<h2 style="margin:0">Edit customer: <?php echo ucwords(strtolower(! empty($supplier->supplier_name) ? $supplier->supplier_name : '')); ?></h2>
		</div>
	...
	<div class="row">
		...
		<div class="contact_details">
			...
			<div class="form-group">
			    {!! Form::label('supplier_name', 'Customer Name:', ['class' => 'control-label']) !!}
