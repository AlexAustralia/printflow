  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <p>Are you sure you wish to delete <strong><?php echo $customer->customer_name; ?></strong> from the database?</p>
        <p>This process cannot be undone.</p>
      </div>
      <div class="modal-footer">
        {!! Form::model($customer, ['id' => 'deleteContact', 'route' => ['customers.destroy', $customer->id], 'method' => 'delete']) !!}
